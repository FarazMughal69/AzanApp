...
class MyColors {
  static const Color lightModtxtClr = Color.fromARGB(255, 224, 247, 250);
// const Color backgroundColor = Color.fromARGB(231, 30, 29, 29);
  ...
  static const Color darkModtxtClr = Color.fromRGBO(33, 33, 33, 1);
  static const Color lightactionColor = Color.fromARGB(255, 255, 223, 114);
  static const Color darkactionColor =
  ...
  static Color textColor(
      {Color darkmodeClr = darkModtxtClr,
      Color lightModeClr = lightModtxtClr}) {
